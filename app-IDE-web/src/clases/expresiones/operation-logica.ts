...
export class OperationLogica {
    ...
    public expresionNegation(valor1: any): boolean{
        if ("boolean" == typeof valor1) {
            ...
            //error no puede negar algo que no sea un booleano XD
            this.errores.capturaExpresiones("No se puede Negar algo que no sea Boolean", valor1+"")
            return valor1
        }
    }
    ...
    private isMismotipo(valor1: any, valor2: any):boolean{
        ...
        if("string" == typeof valor1 && "string" == typeof valor2){
            if(valor1.length ==1 && valor2.length == 1){
                ...
                this.errores.capturaExpresiones("Expresion invalida, para las expresiones Relacionales  deben ser del mismo tipo", valor2+"")
                mismoTipo = false
            }
            ...
            if(Number.isInteger(valor1) && Number.isInteger(valor2)){
                ...
                this.errores.capturaExpresiones("Expresion invalida, para las expresiones Relacionale deben ser del mismo tipo", valor2+"")
                mismoTipo = false
            }
        } else{
            //error no son del mismo tipo
    ...
    private sonBooleanos(valor1: any, valor2: any): boolean{
        if("boolean" == typeof valor1 && "boolean" == typeof valor2){
            ...
            //*error la expresion debe ser entre booleanos
            this.errores.capturaExpresiones("Expresion invalida, para las expresiones Logicas deben ser del  tipo Boolean", valor2+"")
